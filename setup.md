...
3.	For Windows and Linux there is the option of either a 64 bit (default) download or a 32 bit download. Unless you know that you do not have an old 32 bit pc you should choose the 64 bit installer.
